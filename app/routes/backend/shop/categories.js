...
const MainModel 	= require(__path_models + 'categoriesShop');
const MainValidate	= require(__path_validates + 'categoriesShop');
...
router.get('(/status/:status)?', async (req, res, next) => {
	...
	let statusFilter = await UtilsHelpers.createFilterStatus(params.currentStatus, 'categoriesShop');
