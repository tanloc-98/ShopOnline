...
module.exports = {
    listItems: (params, options = null) => {
        ...
        return MainModel
            .find(objWhere)
            .select('name link_product title thumb price status ordering created modified category')
            .sort(sort)
    ...
    listItemsFrontend: (params = null, options = null) => {
        let find = {};
        let select = 'name link_product title thumb price status ordering created modified category';
        let limit = {};
        let sort = '';
    ...
    getItemFrontEnd:(id, options = null) =>{
        return MainModel.findById(id).select('name link_product title thumb price status ordering created modified category');
    },
    ...
    deleteItem:  async (id, options = null) => {
        let linkUpdateFile = "public/uploads/slider/";
